...
import { X, CheckCircle2, Brain, Sparkles, BookOpen, Clock, ShieldCheck } from 'lucide-react';
      ...
      <div className="glass-panel" style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
              ...
              <span style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Grade {lesson.grade_level || 10} • CBSE Syllabus</span>
            </div>
        ...
        <div style={{
          ...
          <iframe
            ...
            src={lesson.embed_code ? lesson.embed_code.match(/src="([^"]+)"/)?.[1] || 'https://www.youtube-nocookie.com/embed/00jbG_cfGuQ' : 'https://www.youtube-nocookie.com/embed/00jbG_cfGuQ'}
            title={lesson.title}
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '14px' }}>
          ...
          >
            <CheckCircle2 size={18} /> Complete & Take 5-Question Quiz
          </button>
        </div>
      </div>
    </div>
